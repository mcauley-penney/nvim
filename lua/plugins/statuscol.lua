        ...
        },
        {
          text = {
            ...
            function(args)
              ...
              local test_wraps = vim.api.nvim_win_text_height(args.win, {
              ...
              if args.virtnum > 0 then
                line = args.virtnum == test_wraps - 1 and '└' or '├'
              end
              ...
              if args.virtnum == 0 and test_wraps == 1 then
              ...
              -- four cases:
              --   start before and end in
              --   start in and end in
              --   start in and end out
              --   start after and end in
              ...
              if normed_s_row == args.lnum and
                  ...
                  (normed_e_row > args.lnum and args.virtnum >= normed_vis_end_wrap) then
                return tools.hl_str("CursorLineNr", line)
              end
