...
return function(client, bufnr)
	...
	map("n", "<leader>gtd", lsp.type_definition, opts("Go To Type Definition"))
	map("n", "<leader>gdc", lsp.declaration, opts("Go To Declaration"))
	map("n", "<leader>gdf", vim.lsp.buf.definition, opts("Go To Definition"))
	map("n", "<leader>gi", vim.lsp.buf.implementation, opts("Go To Implementation"))
	map("n", "<leader>gr", lsp.references, opts("Go To References"))

	map("n", "<leader>r", require(tools .. "rename").exe_rename, opts("LSP Rename"))
